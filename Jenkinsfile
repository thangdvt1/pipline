    ...
    stages {
        ...
        stage('Package to docker image') {
            ...
            steps {
                ...
                sh 'ls -la'
                sh 'ls -la target'
                sh 'docker build -t epay.harbor.com/epay/imagetest:1.0 .'
            }
        }
        stage('Pushing image') {
            steps {
        ...
        stage('Deploying and Cleaning') {
            steps {
                ...
                sh 'docker image rm epay.harbor.com/epay/imagetest:1.0 || echo "this image does not exist" '
                ...
                sh 'docker container run -d --rm --name my-demo-springboot -p 8082:8081 --network jenkins epay.harbor.com/epay/imagetest:1.0'
